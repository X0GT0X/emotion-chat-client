...
class Sidebar extends React.Component {
  render () {
    ...
    return (
      ...
      >
        <div
          className={this.props.width === 'lg' ? classes.toolbar : classes.minifiedToolbar}>
          <IconButton onClick={() => this.props.handleToggleSidebar(false)}
...
Sidebar.propTypes = {
  ...
  accountHandleClick: PropTypes.func,
  logOutHandleClick: PropTypes.func,
  contactsHandleClick: PropTypes.func,
  selectChatHandle: PropTypes.func,
  newChatBtnHandle: PropTypes.func
};
