        ...
        <main>
          {
            messages.filter(_msg => _msg !== null).map((_msg, _index) => <div
              className={this.setDivider(_msg, _index) ? classes.messageContainer : null}
              key={_index}>
              {this.setDivider(_msg, _index) ? <div className={classes.divider}>
                <Typography component='p' variant='body1'
                            className={classes.dividerDate}>
              ...
              <div
                ...
                <div
                  className={_msg.sender.login === this.props.userLogin ? classes.btnContainer : null}>
                  {
                    _msg.sender.login === this.props.userLogin && !_msg.loading ?
                      <IconButton
                  ...
                  {
                    _msg.loading ? <CircularProgress
                      className={classes.loader}/> : null
                  }
                  <div
                    key={_index}
                  ...
                  >
                    {_msg.message}
                    <span
                      className={classes.time}>{this.getTime(new Date(parseInt(_msg.timestamp)))}</span>
                  </div>
                </div>
              </div>
            </div>)
