...
import DeleteGroupDialog from '../../dialogs/DeleteGroupDialog/DeleteGroupDialog';
...
import EditPhotoDialog from '../../dialogs/EditPhotoDialog/EditPhotoDialog';
import ManageMembersDialog from '../../dialogs/ManageMembersDialog/ManageMembersDialog';
      ...
      return (
        ...
        >
          <div className={classes.chatInfo}>
            {
              this.props.selectedChat.type === 'group' ? <div
                ...
                {
                  !this.state.isEditMode ? <Typography variant="h5"
                                                       component="h3"
                ...
                <Typography variant="h6" component="h6"
                  ...
                  Members:
                  <IconButton
                    onClick={() => this.setOpen('manage-members', true)}
                    className={classes.editBtn}><ContactsIcon/></IconButton>
                </Typography>
                <List className={classes.userList}>
                  {
                    users.sort((userA, userB) =>
                      userA.name < userB.name ? -1 : 1).map((user, index) =>
                      <AccountPreview
                        key={index}
                        user={user}
                        handleClick={() => {
                ...
                {
                  this.props.currentUser === this.props.selectedChat.owner ?
                    <Button
                      className={classes.deleteBtn}
