          ...
          <Paper className={classes.paper}>
            ...
            <form onSubmit={(e) => this.submitSignup(e)} className={classes.form}>
              <FormControl required fullWidth margin='normal'>
                ...
                <Input className={classes.input} autoFocus onChange={(e) => this.userTyping('name', e)}
                       id='signup-name-input'/>
              </FormControl>
              <FormControl fullWidth margin='normal'>
                <InputLabel htmlFor='signup-email-input'>Surname(Optional)</InputLabel>
                <Input className={classes.input} onChange={(e) => this.userTyping('surname', e)}
            ...
            <h5 className={classes.hasAccountHeader}>Already Have An Account? <Link className={classes.logInLink}
